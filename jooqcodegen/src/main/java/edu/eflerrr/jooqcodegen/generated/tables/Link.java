...
import edu.eflerrr.jooqcodegen.generated.tables.Branch.BranchPath;
...
public class Link extends TableImpl<LinkRecord> {
    ...
    /**
     * Get the implicit to-many join path to the <code>PUBLIC.Branch</code>
     * table
     */
    public BranchPath branch() {
        if (_branch == null) {
            _branch = new BranchPath(this, null, Keys.CONSTRAINT_77.getInverseKey());
        }
