...
import edu.eflerrr.jooqcodegen.generated.tables.Link.LinkPath;
...
public class Branch extends TableImpl<BranchRecord> {
     ...
     */
    public final TableField<BranchRecord, Long> LINK_ID =
    ...
    public <O extends Record> Branch(
        Table<O> path,
        ForeignKey<O, BranchRecord> childPath,
        InverseForeignKey<O, BranchRecord> parentPath
    ) {
    ...
    public static class BranchPath extends Branch implements Path<BranchRecord> {
        ...
        public <O extends Record> BranchPath(
            Table<O> path,
            ForeignKey<O, BranchRecord> childPath,
            InverseForeignKey<O, BranchRecord> parentPath
        ) {
    ...
    public List<ForeignKey<BranchRecord, ?>> getReferences() {
        return Arrays.asList(Keys.CONSTRAINT_77);
    }
    ...
    public LinkPath link() {
        if (_link == null) {
            _link = new LinkPath(this, Keys.CONSTRAINT_77, null);
        }
